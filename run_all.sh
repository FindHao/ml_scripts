...
output=/home/yhao/d/tmp/runall_eval_profile.log
echo "" > $output
...
func(){
    ...
    do
        ...
        python run.py -d cuda -t eval  --profile --profile-detailed --profile-devices cpu,cuda --profile-folder ./logs_eval/$model  $model  --precision fp32  >> $output 2>&1
    done
}
