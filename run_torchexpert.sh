...
var_date=$(date +'%Y%m%d')
output=/home/yhao/d/tmp/run_torchexpert_$var_date.log
echo "" > $output
cd /home/yhao/d/tmp/
torchexpert=/data/yhao/TorchExpert/torchexpert.py
prefix_path=/home/yhao/d/tmp/
output_csv_file=/home/yhao/d/tmp/torchexpert_results_$var_date.csv
...
do 
    json_path=$prefix_path/logs_profile_train/$model
    if [ -d $json_path ]; then
