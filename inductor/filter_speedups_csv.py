...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input', type=str, default="/tmp/yhao/input.txt")
    parser.add_argument('-o', '--output', type=str, default=f"/home/users/yhao24/b/tmp/profile/output_{now_str}.xlsx")
