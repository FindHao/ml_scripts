...
stream6_raw = torch.cuda.Stream()
stream6 = stream6_raw.cuda_stream
stream7_raw = torch.cuda.Stream()
stream7 = stream7_raw.cuda_stream
stream8_raw = torch.cuda.Stream()
stream8 = stream8_raw.cuda_stream
stream9_raw = torch.cuda.Stream()
stream9 = stream9_raw.cuda_stream
stream10_raw = torch.cuda.Stream()
stream10 = stream10_raw.cuda_stream
stream11_raw = torch.cuda.Stream()
stream11 = stream11_raw.cuda_stream
stream12_raw = torch.cuda.Stream()
stream12 = stream12_raw.cuda_stream
stream13_raw = torch.cuda.Stream()
stream13 = stream13_raw.cuda_stream
stream14_raw = torch.cuda.Stream()
stream14 = stream14_raw.cuda_stream
stream15_raw = torch.cuda.Stream()
stream15 = stream15_raw.cuda_stream
stream16_raw = torch.cuda.Stream()
stream16 = stream16_raw.cuda_stream
stream17_raw = torch.cuda.Stream()
stream17 = stream17_raw.cuda_stream
stream18_raw = torch.cuda.Stream()
stream18 = stream18_raw.cuda_stream
stream19_raw = torch.cuda.Stream()
stream19 = stream19_raw.cuda_stream
stream20_raw = torch.cuda.Stream()
stream20 = stream20_raw.cuda_stream
