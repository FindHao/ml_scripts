...
func2(){
    for (( i = 0 ; i <= $max_iter; i++ )) ; do
        python run.py -d cuda --mode jit -t $mode $model --precision fp32  >> $output 2>&1
    done
}
...
# jit + other opt
for model in mobilenet_v3_large resnext50_32x4d resnet18 timm_efficientnet mnasnet1_0 timm_nfnet shufflenet_v2_x1_0 nvidia_deeprecommender timm_regnet detectron2_fasterrcnn_r_50_c4 detectron2_maskrcnn_r_50_c4 detectron2_fasterrcnn_r_101_c4 detectron2_fasterrcnn_r_50_dc5 detectron2_maskrcnn_r_101_c4 detectron2_fasterrcnn_r_101_dc5 detectron2_fasterrcnn_r_101_fpn detectron2_maskrcnn_r_101_fpn detectron2_fasterrcnn_r_50_fpn detectron2_maskrcnn_r_50_fpn hf_Reformer hf_BigBird detectron2_maskrcnn  mobilenet_v2  timm_resnest timm_vovnet
do 

conda activate pt_sep14
echo "@Yueming Hao origin $model" >>$output
func
conda activate pt_sep14_allopt
